...
SLIDES = [
    ...
    dict(kind="content", kicker="the problem", title="Alzheimer's resists drugs — non-invasive neuromodulation is an open frontier", fig=f"{CF}/landscape.png",
         take="The strongest non-drug clinical evidence today is multidomain lifestyle (FINGER, Ngandu 2015; US POINTER, Baker 2025). Non-invasive stimulation is largely unproven — which is the opportunity.",
    ...
    dict(kind="content", kicker="key references", title="Key references",
         take="Lifestyle: Ngandu 2015 (FINGER) · Baker 2025 (US POINTER).  Clearance: Iliff 2012 · Xie 2013 · Mawuenyega 2010 · Murdock 2024 (40 Hz → glymphatic) · Aryal 2022 / Azadian 2025 (focused ultrasound).  Stimulation: Tsai 2016 (GENUS) · Suk 2023 (40 Hz tactile) · Jiang-Xie–Kipnis 2024 (neural dynamics → CSF).  Guardrail: Buzsáki / Soula (steady-state ≠ entrainment).",
         notes="Grouped anchors. Lifestyle bar — FINGER (Ngandu, Lancet 2015) and U.S. POINTER (Baker, JAMA 2025). Clearance hypothesis & drivers — glymphatic discovery (Iliff, Sci Transl Med 2012), sleep clearance (Xie, Science 2013), slowed Aβ clearance in AD (Mawuenyega, Science 2010), 40 Hz → glymphatic clearance, AQP4-dependent (Murdock, Nature 2024), and Stanford focused ultrasound (Aryal, J Control Release 2022; Azadian, Nat Biotech 2025). Stimulation — origin of sensory-gamma (Tsai 2016), the vibrotactile anchor (Suk 2023), and the mechanism legitimizing brain-state stimulation of clearance (Jiang-Xie–Kipnis 2024). Guardrail — Buzsáki/Soula: a steady-state response is not entrainment. Full lit-review repository available on request."),

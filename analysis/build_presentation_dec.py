...
SLIDES = [
    ...
    dict(kind="content", kicker="and it can be driven", title="And clearance can be driven non-invasively — 40 Hz in mice, focused ultrasound at Stanford", fig=f"{CF}/driving_clearance.png",
         take="40 Hz sensory stimulation drove ~4× CSF influx and ~30% less cortical amyloid, abolished when AQP4 is blocked (Murdock 2024, Nature). Focused ultrasound enhances CSF influx and clearance (Aryal 2022; Azadian 2025). The open question: can a wearable modality do the same?",
         notes="The proof-of-principle that motivates the program. Murdock et al. (2024, Nature) showed 40 Hz multisensory (light + sound) stimulation in AD-model mice increased CSF tracer influx ~4-fold, lowered frontal-cortex amyloid ~30%, and pushed more amyloid into the deep cervical lymph nodes — and blocking the AQP4 water channel abolished it, tying the effect directly to the glymphatic route. Separately, Stanford's focused-ultrasound work (Aryal 2022, J Control Release; Azadian 2025, Nat Biotech) shows another non-invasive route to drive CSF influx and clear debris. Together they say clearance is drivable from outside the skull. The gap none fills: a comfortable, wearable, sleep-compatible modality — the case for vibrotactile, and the bridge to the proposal."),
    ...
    dict(kind="content", kicker="key references", title="Key references",
         take="Lifestyle: Ngandu 2015 (FINGER) · Baker 2025 (US POINTER) · Livingston 2024 (Lancet Commission) · Barnes 2023 (MIND diet — single-domain null).  Clearance: Iliff 2012 · Xie 2013 · Mawuenyega 2010 · Murdock 2024 (40 Hz → glymphatic) · Aryal 2022 / Azadian 2025 (focused ultrasound).  Stimulation: Tsai 2016 (GENUS) · Suk 2023 (40 Hz tactile) · Jiang-Xie–Kipnis 2024 (neural dynamics → CSF).  Guardrail: Buzsáki / Soula (steady-state ≠ entrainment).",
         notes="Grouped anchors. Lifestyle bar — FINGER (Ngandu, Lancet 2015), U.S. POINTER (Baker, JAMA 2025), the Lancet Commission synthesis (Livingston 2024, ~45% modifiable risk), and the single-domain counterpoint (MIND diet alone null; Barnes, NEJM 2023). Clearance hypothesis & drivers — glymphatic discovery (Iliff, Sci Transl Med 2012), sleep clearance (Xie, Science 2013), slowed Aβ clearance in AD (Mawuenyega, Science 2010), 40 Hz → glymphatic clearance, AQP4-dependent (Murdock, Nature 2024), and Stanford focused ultrasound (Aryal, J Control Release 2022; Azadian, Nat Biotech 2025). Stimulation — origin of sensory-gamma (Tsai 2016), the vibrotactile anchor (Suk 2023), and the mechanism legitimizing brain-state stimulation of clearance (Jiang-Xie–Kipnis 2024). Guardrail — Buzsáki/Soula: a steady-state response is not entrainment. Full lit-review repository available on request."),

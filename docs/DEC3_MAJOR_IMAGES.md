...
1. [Condition fingerprint](../analysis/outputs/dec3/biological_summary/condition_fingerprint.png)

   Best compact visual summary of each stimulation condition. Use this as the
   first "what happened across conditions" figure.

2. [Amplitude-frequency matrix](../analysis/outputs/dec3/biological_summary/amplitude_frequency_matrix.png)
...
3. [Broadband vs driven-frequency power](../analysis/outputs/dec3/biological_summary/broadband_vs_driven_power.png)
...
6. [Condition-by-channel LFP response heatmap](../analysis/outputs/dec3/event_aligned_lfp/condition_by_channel_lfp_response_heatmap.png)
...
7. [Time-frequency condition grid](../analysis/outputs/dec3/time_frequency_lfp/time_frequency_condition_grid.png)

   Main time-frequency figure. Use to discuss when frequency-band changes occur
   relative to stimulation onset and offset.

8. [Driven-frequency time courses](../analysis/outputs/dec3/time_frequency_lfp/driven_frequency_timecourses.png)

   Time courses for driven-frequency power. Use to compare sustained ON effects
   with offset/recovery effects.

9. [Frequency specificity by group](../analysis/outputs/dec3/frequency_lfp/frequency_specificity_by_group.png)
...
12. [Sustained broadband confidence intervals](../analysis/outputs/dec3/trial_level_stats_equal_spectral_windows/sustained_broadband_ci.png)

    Bootstrap confidence intervals for sustained broadband response. This is one
    of the main statistical-support figures.

13. [Driven-power confidence intervals](../analysis/outputs/dec3/trial_level_stats_equal_spectral_windows/driven_power_ci.png)
...
14. [Broadband transition windows by condition](../analysis/outputs/dec3/broadband_transition/broadband_windows_condition_ci.png)
...
15. [Transition index by condition](../analysis/outputs/dec3/broadband_transition/transition_index_condition.png)

    Compact transition-index figure. Use for explaining ON-dominant versus
    OFF/recovery-dominant responses.

16. [OFF-control broadband effect](../analysis/outputs/dec3/off_control_broadband/off_control_condition_ci.png)
...
17. [Adaptation time courses](../analysis/outputs/dec3/adaptation_analysis/adaptation_timecourses.png)

    Adaptation across repeated trials. Use for the observation that responses
    change across the 200 repeats.

18. [Adaptation slope summary](../analysis/outputs/dec3/adaptation_analysis/adaptation_slope_summary.png)
...
19. [Cluster quality scatter](../analysis/outputs/dec3/cluster_quality/cluster_quality_scatter.png)
...
20. [Cluster quality label counts](../analysis/outputs/dec3/cluster_quality/cluster_quality_label_counts.png)
...
21. [High-confidence spike unit-set comparison](../analysis/outputs/dec3/spike_peth_high_confidence/condition_mean_on_minus_off_unit_set_comparison.png)

    Main spike result after cleaner filtering. It compares all clusters,
    KS-good clusters, and high-confidence KS-good clusters.

22. [High-confidence spike heatmap](../analysis/outputs/dec3/spike_peth_high_confidence/high_confidence_unit_condition_heatmap.png)

    High-confidence unit-by-condition ON-minus-OFF heatmap.

23. [High-confidence onset PETH](../analysis/outputs/dec3/spike_peth_high_confidence/peth_onset_high_confidence_units.png)

    Onset-aligned PETH for the 19 high-confidence units.

24. [High-confidence offset PETH](../analysis/outputs/dec3/spike_peth_high_confidence/peth_offset_high_confidence_units.png)

    Offset-aligned PETH for the 19 high-confidence units.

25. [Original KS-good unit heatmap](../analysis/outputs/dec3/spike_peth_on_off/unit_condition_on_minus_off_heatmap_ks_good.png)

    Original KS-good unit heatmap before the stricter high-confidence filter.

## Quality Control And Setup Figures

26. [Baseline channel QC metrics](../analysis/outputs/dec3/channel_qc_baseline/channel_qc_metrics.png)

    Baseline channel QC metrics. Use when explaining bad-channel exclusion.

27. [High-noise review traces](../analysis/outputs/dec3/channel_qc_baseline/high_noise_review_traces.png)

    Visual review traces for high-noise candidate channels.

28. [TTL ON/OFF counts](../analysis/outputs/dec3/ttl_on_off_audit/ttl_on_off_counts.png)

    TTL event audit figure confirming the 3 s ON / 3 s OFF event structure used
    for the analysis.

29. [SpikeInterface trace sanity check](../analysis/outputs/dec3/spikeinterface_setup/spikeinterface_trace_sanity.png)

    SpikeInterface raw trace sanity check.

30. [Kilosort diagnostics](../analysis/outputs/dec3/modal_kilosort4_results/kilosort4_results/diagnostics.png)

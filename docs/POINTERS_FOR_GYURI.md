...
4. [raster_psth_examples_dec4.png](https://github.com/wehabit/hpaticmousebuzsakilab/blob/main/results/dec4/11_Spikes/raster_psth_examples_dec4.png)
   — actual spikes per trial + the never-stimulated pre-study baseline (the concrete,
   can't-fake-it figure).
5. [psth_frequency_specific_dec4.png](https://github.com/wehabit/hpaticmousebuzsakilab/blob/main/results/dec4/11_Spikes/psth_frequency_specific_dec4.png)
   — response only at 50 Hz (frequency specificity).
6. [raster_psth_all_good_units_combined.png](https://github.com/wehabit/hpaticmousebuzsakilab/blob/main/results/dec4/11_Spikes/raster_psth_all_good_units_combined.png)
   — every curated unit + the Dec 3 negative control, on one shared scale.

## C. Did you catch your own artifact / are you overclaiming?

7. [50hz_pickup_gradient_dhpc_vs_lec.png](https://github.com/wehabit/hpaticmousebuzsakilab/blob/main/results/dec4/12_ChannelQC_Traces/50hz_pickup_gradient_dhpc_vs_lec.png)
   — disconnected channels carry the 50 Hz LFP ~6× → the LFP effect is largely pickup.
8. [spectral_slope_itpc_dec4.png](https://github.com/wehabit/hpaticmousebuzsakilab/blob/main/results/dec4/05_Frequency_Spectral/spectral_slope_itpc_dec4.png)
...
9. [unit87_acg_artifact_screen.png](https://github.com/wehabit/hpaticmousebuzsakilab/blob/main/results/dec4/11_Spikes/unit87_acg_artifact_screen.png)
...
10. [fiftyhz_tissue_contamination_dec4.png](https://github.com/wehabit/hpaticmousebuzsakilab/blob/main/results/dec4/12_ChannelQC_Traces/fiftyhz_tissue_contamination_dec4.png)
...
11. [trial_avg_spectrogram_dec4.png](https://github.com/wehabit/hpaticmousebuzsakilab/blob/main/results/dec4/05_Frequency_Spectral/trial_avg_spectrogram_dec4.png)
...
12. [dec4_celltype.png](https://github.com/wehabit/hpaticmousebuzsakilab/blob/main/results/dec4/11_Spikes/dec4_celltype.png)
...
13. [spike_50hz_interpretation.png](https://github.com/wehabit/hpaticmousebuzsakilab/blob/main/results/dec4/11_Spikes/spike_50hz_interpretation.png)
